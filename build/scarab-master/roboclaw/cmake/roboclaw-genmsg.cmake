...
set(MSG_I_FLAGS "-Iroboclaw:/home/dwkush/catkin_ws_2/src/scarab-master/roboclaw/msg;-Igeometry_msgs:/opt/ros/melodic/share/geometry_msgs/cmake/../msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/dwkush/catkin_ws_2/src/scarab-master/roboclaw/msg/motor_state.msg" NAME_WE)
add_custom_target(_roboclaw_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "roboclaw" "/home/dwkush/catkin_ws_2/src/scarab-master/roboclaw/msg/motor_state.msg" ""
)
...
_generate_msg_cpp(roboclaw
  "/home/dwkush/catkin_ws_2/src/scarab-master/roboclaw/msg/motor_state.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/roboclaw)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/roboclaw\")")
  # install generated code
  install(
